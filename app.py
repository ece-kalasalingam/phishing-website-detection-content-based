...
with st.expander("PROJECT DETAILS"):
    ...
    st.write('We have used _supervised learning_ to classify phishing and legitimate websites. '
             'It benefit from content-based approach and we firstly focus on html of the websites. '
             'And also, we used scikit-learn for the ML models.'
             )
    ...
    st.write('Firstly, we have used only content-based features. Still we didn\'t use url-based faetures like length of url etc.'
             'Most of the features extracted using find_all() method of BeautifulSoup module after parsing html.')

    st.subheader('Results')
    st.write('We have used 7 different ML classifiers of scikit-learn and tested them implementing k-fold cross validation.'
